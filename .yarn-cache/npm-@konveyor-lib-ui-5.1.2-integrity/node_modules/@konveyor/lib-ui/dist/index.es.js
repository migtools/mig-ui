...
import { Flex, FlexItem, Spinner, FormGroup, TextInput, TextArea } from '@patternfly/react-core';
import { global_disabled_color_200, global_success_color_100, global_warning_color_100, global_danger_color_100, global_info_color_100, global_info_color_200, global_Color_dark_200 } from '@patternfly/react-tokens';
...
var iconList = {
    Ok: {
        ...
        color: global_success_color_100,
    },
    Warning: {
        Icon: ExclamationTriangleIcon,
        color: global_warning_color_100,
    },
    Error: {
        Icon: ExclamationCircleIcon,
        color: global_danger_color_100,
    },
    Info: {
        Icon: InfoCircleIcon,
        color: global_info_color_100,
    },
    Loading: {
        Icon: Spinner,
        color: global_info_color_200,
    },
    Paused: {
...
var StatusIcon = function (_a) {
    ...
    var icon = (React.createElement(Icon, { color: isDisabled ? global_disabled_color_200.value : ((_b = iconList[status].color) === null || _b === void 0 ? void 0 : _b.value) || '#151515', className: status === 'Loading' ? className + " status-icon-loading-spinner" : className }));
    if (label) {
        return (React.createElement(Flex, { spaceItems: { default: 'spaceItemsSm' }, alignItems: { default: 'alignItemsCenter' }, flexWrap: { default: 'nowrap' }, style: { whiteSpace: 'nowrap' }, className: className },
            React.createElement(FlexItem, null, icon),
            React.createElement(FlexItem, null, label)));
    }
    return icon;
};
...
var useFormField = function (initialValue, schema, options) {
    ...
    var _a = React.useState(initialValue), defaultValue = _a[0], setDefaultValue = _a[1]; // The value used on clear()
    var _b = React.useState(initialValue), cleanValue = _b[0], setCleanValue = _b[1]; // The value considered "unchanged", determines isDirty and used on revert()
    var _c = React.useState(initialValue), value = _c[0], setValue = _c[1]; // The actual value in the field
    var _d = React.useState(options.initialTouched || false), isTouched = _d[0], setIsTouched = _d[1];
    return {
        value: value,
        setValue: setValue,
...
var useFormState = function (fields, yupOptions) {
    ...
    var _a = React.useState(null), validationError = _a[0], setValidationError = _a[1];
    var _b = React.useState(false), hasRunInitialValidation = _b[0], setHasRunInitialValidation = _b[1];
    var lastValuesRef = React.useRef(values);
    ...
    var validatedFields = fieldKeys.reduce(function (newObj, key) {
        ...
        var validatedField = __assign(__assign({}, field), { error: error, isValid: !error || !field.isTouched });
...
var getFormGroupProps = function (field) {
    var _a;
    return ({
...
var getTextFieldProps = function (field) { return ({
    value: field.value,
    onChange: field.setValue,
    onBlur: function () { return field.setIsTouched(true); },
    validated: field.isValid ? 'default' : 'error',
}); };
var getTextInputProps = function (field) { return getTextFieldProps(field); };
var getTextAreaProps = function (field) { return getTextFieldProps(field); };

var ValidatedTextInput = function (_a) {
    var field = _a.field, _b = _a.component, component = _b === void 0 ? TextInput : _b, label = _a.label, fieldId = _a.fieldId, isRequired = _a.isRequired, _c = _a.type, type = _c === void 0 ? 'text' : _c, _d = _a.formGroupProps, formGroupProps = _d === void 0 ? {} : _d, _e = _a.inputProps, inputProps = _e === void 0 ? {} : _e;
    return (React.createElement(FormGroup, __assign({ label: label, isRequired: isRequired, fieldId: fieldId }, getFormGroupProps(field), formGroupProps), component === TextInput ? (React.createElement(TextInput, __assign({ id: fieldId, type: type }, getTextInputProps(field), inputProps))) : (React.createElement(TextArea, __assign({ id: fieldId }, getTextAreaProps(field), inputProps, { ref: null })))));
};
...
var useSelectionState = function (_a) {
    ...
    var internalState = React.useState(initialSelected);
...
var ExtendedCoreNamespacedResourceKind;
(function (ExtendedCoreNamespacedResourceKind) {
    ExtendedCoreNamespacedResourceKind["Log"] = "log";
})(ExtendedCoreNamespacedResourceKind || (ExtendedCoreNamespacedResourceKind = {}));
var CoreNamespacedResourceKind;
(function (CoreNamespacedResourceKind) {
    CoreNamespacedResourceKind["Pod"] = "pods";
    CoreNamespacedResourceKind["Secret"] = "secrets";
})(CoreNamespacedResourceKind || (CoreNamespacedResourceKind = {}));
var CoreClusterResourceKind;
(function (CoreClusterResourceKind) {
    CoreClusterResourceKind["Namespace"] = "namespaces";
    CoreClusterResourceKind["PV"] = "persistentvolumes";
})(CoreClusterResourceKind || (CoreClusterResourceKind = {}));

export { ClientFactory, ClientFactoryMissingApiRoot, ClientFactoryMissingUserError, ClientFactoryUnknownClusterError, ClientTokenExpiredError, ClusterClient, ClusterResource, CoreClusterResource, CoreClusterResourceKind, CoreNamespacedResource, CoreNamespacedResourceKind, ExtendedCoreNamespacedResource, ExtendedCoreNamespacedResourceKind, NamespacedResource, OAuthClient, StatusIcon, ValidatedTextInput, getFormGroupProps, getTextAreaProps, getTextFieldProps, getTextInputProps, setTokenExpiryHandler, useFormField, useFormState, useSelectionState };
