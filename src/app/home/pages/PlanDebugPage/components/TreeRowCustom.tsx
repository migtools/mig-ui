          ...
          {setsize > 0 && (
            <span className={css(stylesTreeView.tableToggle)}>
              <Button
                ...
                aria-label={
                  toggleAriaLabel || `${isExpanded ? 'Collapse' : 'Expand'} row ${rowIndex}`
                }
              >
          ...
          {!!onToggleRowDetails && (
            <span className={css(stylesTreeView.tableTreeViewDetailsToggle)}>
              <Button
                ...
                onClick={(event) =>
                  onToggleRowDetails && onToggleRowDetails(event, rowIndex, content, rowData)
                }
              >
