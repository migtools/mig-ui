import { TreeViewList } from '@patternfly/react-core/dist/js/components/TreeView/TreeViewList';
    ...
    <TreeViewList isNested={isNested} onSearch={onSearch} searchProps={searchProps}>
      {data.map((item) => (
        <TreeViewListItem
          ...
          defaultExpanded={
            item.defaultExpanded !== undefined ? item.defaultExpanded : defaultAllExpanded
          }
          onSelect={onSelect}
          onCheck={onCheck}
