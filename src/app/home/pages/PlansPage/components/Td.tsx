...
import { BaseCellProps } from '@patternfly/react-table/dist/js/components/TableComposable';
import {
  OnSelect,
  IActions,
  OnCollapse,
...
import { mergeProps } from '@patternfly/react-table/dist/js/components/Table/base';
import { IVisibility } from '@patternfly/react-table/dist/js/components/Table/utils/decorators/classNames';
export interface TdProps
  extends BaseCellProps,
    Omit<React.HTMLProps<HTMLTableDataCellElement>, 'onSelect' | 'width'> {
  /**
  ...
  return (
    <MergedComponent
      ...
      className={css(
        ...
        styles.modifiers[
          modifier as 'breakWord' | 'fitContent' | 'nowrap' | 'truncate' | 'wrap' | undefined
        ],
        mergedClassName
      )}
      ref={innerRef}
