...
export const reportFetchSuccess = (
  state = INITIAL_STATE,
  action: ReturnType<typeof LogActions.reportFetchSuccess>
) => {
...
export const reportFetchFailure = (
  state = INITIAL_STATE,
  action: ReturnType<typeof LogActions.reportFetchFailure>
) => {
...
export const logFetchRequest = (
  state = INITIAL_STATE,
  action: ReturnType<typeof LogActions.logFetchRequest>
) => {
...
export const logFetchSuccess = (
  state = INITIAL_STATE,
  action: ReturnType<typeof LogActions.logsFetchSuccess>
) => {
...
export const logFetchFailure = (
  state = INITIAL_STATE,
  action: ReturnType<typeof LogActions.logsFetchFailure>
) => {
...
export const createLogArchive = (
  state = INITIAL_STATE,
  action: ReturnType<typeof LogActions.createLogArchive>
) => {
...
const planReducer = (state = INITIAL_STATE, action) => {
  switch (action.type) {
    ...
    case LogActionTypes.REPORT_FETCH_REQUEST:
      return reportFetchRequest(state, action);
    case LogActionTypes.REPORT_FETCH_FAILURE:
      return reportFetchFailure(state, action);
    case LogActionTypes.LOG_FETCH_SUCCESS:
      return logFetchSuccess(state, action);
    case LogActionTypes.LOG_FETCH_REQUEST:
      return logFetchRequest(state, action);
    case LogActionTypes.LOG_FETCH_FAILURE:
      return logFetchFailure(state, action);
    case LogActionTypes.CREATE_LOG_ARCHIVE:
      return createLogArchive(state, action);
    default:
      return state;
  }
};
